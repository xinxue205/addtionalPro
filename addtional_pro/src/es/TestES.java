...
public class TestES {
	...
	static {
		...
		try {
			client = new PreBuiltTransportClient(settings).addTransportAddresses(
			        ...
			        // new InetSocketTransportAddress(InetAddress.getByName("192.168.110.133"),
			        // 9300),
			        new TransportAddress(InetAddress.getByName("47.112.175.187"), 9300));
	...
	public static void main(String[] args) throws Exception {
		TestES t = new TestES();
		t.esDelete(EsConstants.DOC_STANDARD_GOODS, EsConstants.DOC_STANDARD_GOODS, "2c92f8c0797d7665017a5c35fb1a000b");
//		t.esUpdate();
	}
	
	
	public static TransportResponse get(AbstractClient client, String index, String type, String id) {
    ...
    public void esCreate() throws IOException {
        IndexResponse response = client.prepareIndex("people", "student", "3")
                .setSource(jsonBuilder().startObject().field("username", "王五五").field("sex", "男")
                        .field("birthday", new Date()).field("age", 21).field("message", "trying out es")
                        .endObject())
                .get();
    ...
    public void esGet() throws IOException {
    ...
    public void esMultiGet() throws IOException {
    ...
    public void esUpdate() throws Exception {
        // 创建一个更新的请求对象
    ...
    public void esDeleteByQueryAsync() {
    ...
    public void esAddPlayer() throws IOException {
        //
    ...
    public void esAgg1() {
        ...
        // 使用Iterator进行遍历迭代
        Iterator<Bucket> teamBucketIt = terms.getBuckets().iterator();
    ...
    public void esAgg5() {
        ...
        // 按team进行分组，然后指定排序规则
        TermsAggregationBuilder termsAgg = AggregationBuilders.terms("team_name").field("team")
                .order(BucketOrder.aggregation("total_salary ", true));
        // 指定一个聚合函数是求和
        SumAggregationBuilder sumAgg = AggregationBuilders.sum("total_salary").field("salary");
