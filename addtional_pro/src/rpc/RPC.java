...
import rpc.protocal.Invocation;
import rpc.support.Client;
import rpc.support.Listener;
	...
	public static <T> T getProxy(final Class<T> clazz,String host,int port) {
		...
		InvocationHandler handler = new InvocationHandler() {
			...
			public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
				...
				invo.setMethod(new rpc.protocal.Method(method.getName(),method.getParameterTypes()));
				invo.setParams(args);
				client.invoke(invo);
