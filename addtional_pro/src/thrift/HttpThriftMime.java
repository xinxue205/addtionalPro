...
public class HttpThriftMime{
	...
	public static String servName = "/service";
...
//            System.exit(1);
//        }
		Thread t = new RequestListenerThread(port);//, args[0]);
        t.setDaemon(false);
        t.start();
	}
    ...
    static class HttpFileHandler implements HttpRequestHandler {
        ...
        public void handle(final HttpRequest request, final HttpResponse response, final HttpContext context) throws HttpException, IOException {
            ...
            if (request instanceof HttpEntityEnclosingRequest && target.equals(servName)) {
    ...
    static class RequestListenerThread extends Thread {
        ...
        public RequestListenerThread(int port) throws IOException { //, final String docroot) throws IOException {
        	String docroot = "D:\\download\\车票实名制核查问题排查.docx";
        	this.docroot = docroot;
