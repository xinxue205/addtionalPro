 ...
 * @author Shawn.wu
 * @date 2014-7-23 上午9:31:20
 * @Description
 * @version 1.0 Shawn create
 */
public class BufferedRandomAccessFile extends RandomAccessFile {

    static ResourceBundle res = ResourceBundle.getBundle("com.nantian.journal.filestruct.Res");
    ...
    public static void main(String[] args) throws IOException {
        ...
        brafReadFile = new BufferedRandomAccessFile("D:\\Upload.zip");
        readfilelen = brafReadFile.initfilelen;
        brafWriteFile = new BufferedRandomAccessFile("D:\\Upload1.zip", "rw", 10);
        ...
        java.io.FileInputStream fdin = new java.io.FileInputStream("D:\\440600100151_20091115.txt");
        java.io.BufferedInputStream bis = new java.io.BufferedInputStream(fdin, 1024);
        java.io.DataInputStream dis = new java.io.DataInputStream(bis);

        java.io.FileOutputStream fdout = new java.io.FileOutputStream("D:\\440600100151_20091115_2.txt");
